...
public class PlayerControllerX : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(boostInput)
        {
            turboBoost(forwardInput);
        }

    }
    void turboBoost(float forwardInput)
    {
        playerRb.AddForce(focalPoint.transform.forward * turboSpeed * forwardInput * Time.deltaTime);
    }
